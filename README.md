...
3. Самой эффективной в плане расходования ресурсов считается схема управления waterfall (водопад). То есть один раз согласовали требования, спланировали, выполнили и сдали. На практике такого не бывает.
